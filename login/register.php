    ...
    <div class="container" style="margin-top: 20.6%;">
        <div class="card col-md-6 position-relative top-50 start-50 translate-middle">
            <div class="card-body">
                ...
                <a href="../index.php" class="btn btn-outline-info form-control  mt-3">Register</a>
                <p class="text-center"><b>Sudah punya akun?</b></p>
                <a href="/login/login.php" class="btn btn-outline-info form-control">Login</a>
            </div>
        </div>
    </div>
    <?php
